...
\usepackage{tikz} %Kein Zeichenprogramm.
	...
	%\usepackage{iften} % Erstmal nur für todonote Package
...
%mathematical environments
	%% make the math theorems appeare in tableofcontents %%
		\usepackage{thmtools}
...
%\newcommand{\hinweise}[1]{\footnotesize \begin{proof*} #1 \hfill $\square$ \end{proof*}\normalsize}
