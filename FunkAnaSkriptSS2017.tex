...
\begin{enumerate}[]
	...
	$\df (x_n)$ hat keine Cauchy-Teilfolge $\df (x_n)$ hat keine konvergente Teilfolge.
			...
			Da $X$ präkompakt ist, gibt es zu $\varepsilon = 1$ endliche viele Kugeln $U_1(x_0,j)$ mit 
	...
	\begin{cor}
		$(X,d)$ metrischer Raum
			\begin{enumerate}[a)]
				...
				\item $M\subset X$, so dass jede Folge in M eine in M konvergente Teilfolge hat (\afs M folgenkompakt\afs)
