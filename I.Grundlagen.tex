...
{
\footnotesize
Was macht man in der Funktionalanalysis? man definiert sich einen vernünfitgen Abstandsbegriff: z.B. den Begriff der \glslink{metrischer Raum}{Metrik} auf (zunächst einmal) einer beliebigen Mengen $E$. Damit hat man einen \glslink{metrischer Raum}{metrischen Raum} geschaffen.
}
...
%Satz 1.62
	...
	\end{proof}
	Übung. Blatt \hyperref[B5.1]{5}, \hyperref[B6.1]{6}.
	\begin{enumerate}
